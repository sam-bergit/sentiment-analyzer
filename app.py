...
# Define the route for analyzing sentiment and subjectivity
...
def analyze():
    ...
    if 'text' in request.form and request.form['text'].strip() != "":
        ...
        results.append((text, sentiment, subjectivity))  # Store the result as a list of tuples
    ...
    # Check if a file is submitted through the form
        ...
        # Iterate over each text entry in the DataFrame and analyze sentiment and subjectivity
